...
ACLOCAL = ${SHELL} /tmp/Cowry/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /tmp/Cowry/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /tmp/Cowry/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /tmp/Cowry/build-aux/missing automake-1.15
AWK = gawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /tmp/Cowry/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
PACKAGE_STRING = Cowry Core 1.0.0
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /tmp/Cowry
abs_srcdir = /tmp/Cowry
abs_top_builddir = /tmp/Cowry
abs_top_srcdir = /tmp/Cowry
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /tmp/Cowry/build-aux/install-sh
