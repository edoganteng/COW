...
RESOURCES += src/qt/cowry.qrc src/qt/cowry_locale.qrc

TRANSLATIONS += src/qt/locale/cowry_bg.ts \
                src/qt/locale/cowry_de.ts \
                src/qt/locale/cowry_en.ts \
                src/qt/locale/cowry_es.ts \
                src/qt/locale/cowry_fi.ts \
                src/qt/locale/cowry_fr.ts \
                src/qt/locale/cowry_it.ts \
                src/qt/locale/cowry_ja.ts \
                src/qt/locale/cowry_pl.ts \
                src/qt/locale/cowry_pt.ts \
                src/qt/locale/cowry_ru.ts \
                src/qt/locale/cowry_sk.ts \
                src/qt/locale/cowry_sv.ts \
                src/qt/locale/cowry_vi.ts \
                src/qt/locale/cowry_zh_CN.ts \
                src/qt/locale/cowry_zh_TW.ts
