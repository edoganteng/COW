Contributing to Cowry Core
============================

The Cowry Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Cowry Core project, and is not to be
confused with overall Cowry Network Protocol consensus changes.

Whether a pull request is merged into Cowry Core rests with the project merge
...
Patches that change Cowry consensus rules are considerably more involved than
...
Where a patch set proposes to change the Cowry consensus, it must have been
...
The project leader is the release manager for each Cowry Core release.
