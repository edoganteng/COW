...
In order to support loading of multiple wallets in cowry-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cowry.cpp.
...
Changes to cowry.cpp
----------------------
cowry.cpp is the entry point into cowry-qt, and as such, will require some minor modifications to provide hooks for
