...
#   c) node1 mines 32 blocks, so now node 0 has 60001cow, node 1 has 4250cow, node2 has none.
#   d) node0 sends 601 cow to node2, in two transactions (301 cow, then 300 cow).
