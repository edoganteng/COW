...
#ifndef Cowry_STAKEINPUT_H
#define Cowry_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZCOW() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zCOWStake can take two forms
// 1) the stake candidate, which is a zcmint that is attempted to be staked
// 2) a staked zcow, which is a zcspend that has successfully staked
...
public:
    ...
    bool IsZCOW() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZCOW() override { return false; }
};


#endif //Cowry_STAKEINPUT_H
