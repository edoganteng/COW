...
extern UniValue setzcowseed(const UniValue& params, bool fHelp);
extern UniValue getzcowseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzcow(const UniValue& params, bool fHelp);
extern UniValue dzcowstate(const UniValue& params, bool fHelp);
