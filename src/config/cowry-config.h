/* src/config/cowry-config.h.  Generated from cowry-config.h.in by configure.  */
/* src/config/cowry-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.cowry.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Cowry Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Cowry Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "cowry"
