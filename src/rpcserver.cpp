...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Cowry features */
        {"cowry", "masternode", &masternode, true, true, false},
        {"cowry", "listmasternodes", &listmasternodes, true, true, false},
        {"cowry", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cowry", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cowry", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"cowry", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"cowry", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"cowry", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cowry", "masternodedebug", &masternodedebug, true, true, false},
        {"cowry", "startmasternode", &startmasternode, true, true, false},
        {"cowry", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cowry", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cowry", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cowry", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cowry", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cowry", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cowry", "mnbudget", &mnbudget, true, true, false},
        {"cowry", "preparebudget", &preparebudget, true, true, false},
        {"cowry", "submitbudget", &submitbudget, true, true, false},
        {"cowry", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"cowry", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"cowry", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"cowry", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"cowry", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"cowry", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"cowry", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cowry", "checkbudgets", &checkbudgets, true, true, false},
        {"cowry", "mnsync", &mnsync, true, true, false},
        {"cowry", "spork", &spork, true, true, false},
        {"cowry", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzcowseed", &getzcowseed, false, false, true},
        {"zerocoin", "setzcowseed", &setzcowseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzcow", &searchdzcow, false, false, true},
        {"zerocoin", "dzcowstate", &dzcowstate, false, false, true}
...
{
    return "> cowry-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:6625/\n";
}
