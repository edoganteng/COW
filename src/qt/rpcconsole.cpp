                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzCOWPathCustom = GetArg("-zcowbackuppath", "");
    ...
    if(!strzCOWPathCustom.empty()) {
        ui->wallet_customzcowbackuppath->setText(QString::fromStdString(strzCOWPathCustom));
        ui->wallet_customzcowbackuppath_label->setVisible(true);
        ui->wallet_customzcowbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzCOWPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Cowry RPC console.") + "<br>" +
