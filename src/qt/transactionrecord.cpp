...
QList<TransactionRecord> TransactionRecord::decomposeTransaction(const CWallet* wallet, const CWalletTx& wtx)
{
    ...
    if (wtx.IsCoinStake()) {
        ...
        if (wtx.IsZerocoinSpend() && (fZSpendFromMe || wallet->zcowTracker->HasMintTx(hash))) {
            //zCOW stake reward
            sub.involvesWatchAddress = false;
            sub.type = TransactionRecord::StakeZCOW;
...
bool IsZCOWType(TransactionRecord::Type type)
{
    switch (type) {
        case TransactionRecord::StakeZCOW:
...
void TransactionRecord::updateStatus(const CWalletTx& wtx)
{
    ...
    else if (type == TransactionRecord::Generated || type == TransactionRecord::StakeMint || type == TransactionRecord::StakeZCOW || type == TransactionRecord::MNReward) {
