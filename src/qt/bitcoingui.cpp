                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Cowry Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Cowry address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cowry: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zCOW"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Cowry Core"), this);
    aboutAction->setStatusTip(tr("Show information about Cowry Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Cowry"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Cowry addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Cowry addresses"));
    ...
    openAction->setStatusTip(tr("Open a Cowry: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Cowry Core help message to get a list with possible Cowry command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Cowry Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Cowry network", "", count));
}
...
{
    QString strTitle = tr("Cowry Core"); // default title
