...
/* Cowry GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Cowry"
#define QAPP_ORG_DOMAIN "cowry.org"
#define QAPP_APP_NAME_DEFAULT "Cowry-Qt"
#define QAPP_APP_NAME_TESTNET "Cowry-Qt-testnet"
