...
/** Utility functions used by the Cowry Qt UI.
 */
namespace GUIUtil
{
...
// Render Cowry addresses in monospace font
...
// Parse "cowry:" URI into recipient object, return true on successful parsing
